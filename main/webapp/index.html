...
<title>Nithesh Banking | Welcome.</title>
...
<body>
	<header>
		<div class="container">
			<div id ="branding">
				<h1><span class="highlight">Nithesh</span> Banking Inc.</h1>
			</div>
			<nav>
				<ul>
	...
	<section id ="showcase">
		<div class="container">
		<h1>India's Most Easiest Online Banking.</h1>
		<p>Save you a trip to the bank.</p>
		</div>
	</section>
	<section id ="options">
		<div class="container">
			<h1> Welcome to Nithesh Internet Banking. Please choose an option to proceed.</h1>
	...
	<footer>
		<p>Nithesh Banking Inc. copyright &copy; 2021</p>
